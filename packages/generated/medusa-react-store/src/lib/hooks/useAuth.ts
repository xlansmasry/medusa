...
import type { StoreAuthRes } from '@medusajs/medusa-client-types';
import type { StoreGetAuthEmailRes } from '@medusajs/medusa-client-types';
import type { StorePostAuthReq } from '@medusajs/medusa-client-types';
