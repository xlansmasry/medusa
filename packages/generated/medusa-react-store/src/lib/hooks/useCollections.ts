...
import type { StoreCollectionsListRes } from '@medusajs/medusa-client-types';
import type { StoreCollectionsRes } from '@medusajs/medusa-client-types';
import type { StoreGetCollectionsParams } from '@medusajs/medusa-client-types';
