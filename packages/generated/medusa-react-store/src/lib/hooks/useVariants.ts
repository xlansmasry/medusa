...
import type { StoreGetVariantsParams } from '@medusajs/medusa-client-types';
import type { StoreGetVariantsVariantParams } from '@medusajs/medusa-client-types';
import type { StoreVariantsListRes } from '@medusajs/medusa-client-types';
import type { StoreVariantsRes } from '@medusajs/medusa-client-types';
