...
import type { AdminGetSwapsParams } from '@medusajs/medusa-client-types';
import type { AdminSwapsListRes } from '@medusajs/medusa-client-types';
import type { AdminSwapsRes } from '@medusajs/medusa-client-types';
