...
import type { AdminGetStockLocationsLocationParams } from '@medusajs/medusa-client-types';
import type { AdminGetStockLocationsParams } from '@medusajs/medusa-client-types';
import type { AdminPostStockLocationsLocationReq } from '@medusajs/medusa-client-types';
import type { AdminPostStockLocationsReq } from '@medusajs/medusa-client-types';
import type { AdminStockLocationsListRes } from '@medusajs/medusa-client-types';
import type { AdminStockLocationsRes } from '@medusajs/medusa-client-types';
