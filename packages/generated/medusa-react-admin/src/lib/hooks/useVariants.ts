...
import type { AdminGetVariantsParams } from '@medusajs/medusa-client-types';
import type { AdminGetVariantsVariantInventoryRes } from '@medusajs/medusa-client-types';
import type { AdminVariantsListRes } from '@medusajs/medusa-client-types';
