...
import type { AdminCustomerGroupsDeleteRes } from '@medusajs/medusa-client-types';
import type { AdminCustomerGroupsListRes } from '@medusajs/medusa-client-types';
import type { AdminCustomerGroupsRes } from '@medusajs/medusa-client-types';
import type { AdminCustomersListRes } from '@medusajs/medusa-client-types';
import type { AdminDeleteCustomerGroupsGroupCustomerBatchReq } from '@medusajs/medusa-client-types';
import type { AdminGetCustomerGroupsGroupParams } from '@medusajs/medusa-client-types';
import type { AdminGetCustomerGroupsParams } from '@medusajs/medusa-client-types';
import type { AdminGetGroupsGroupCustomersParams } from '@medusajs/medusa-client-types';
import type { AdminPostCustomerGroupsGroupCustomersBatchReq } from '@medusajs/medusa-client-types';
import type { AdminPostCustomerGroupsGroupReq } from '@medusajs/medusa-client-types';
import type { AdminPostCustomerGroupsReq } from '@medusajs/medusa-client-types';
