...
import type { AdminGetPaymentCollectionsParams } from '@medusajs/medusa-client-types';
import type { AdminPaymentCollectionDeleteRes } from '@medusajs/medusa-client-types';
import type { AdminPaymentCollectionsRes } from '@medusajs/medusa-client-types';
import type { AdminUpdatePaymentCollectionsReq } from '@medusajs/medusa-client-types';
