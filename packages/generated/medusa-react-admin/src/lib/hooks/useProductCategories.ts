...
import type { AdminDeleteProductCategoriesCategoryProductsBatchParams } from '@medusajs/medusa-client-types';
import type { AdminDeleteProductCategoriesCategoryProductsBatchReq } from '@medusajs/medusa-client-types';
import type { AdminGetProductCategoriesParams } from '@medusajs/medusa-client-types';
import type { AdminGetProductCategoryParams } from '@medusajs/medusa-client-types';
import type { AdminPostProductCategoriesCategoryParams } from '@medusajs/medusa-client-types';
import type { AdminPostProductCategoriesCategoryProductsBatchParams } from '@medusajs/medusa-client-types';
import type { AdminPostProductCategoriesCategoryProductsBatchReq } from '@medusajs/medusa-client-types';
import type { AdminPostProductCategoriesCategoryReq } from '@medusajs/medusa-client-types';
import type { AdminPostProductCategoriesParams } from '@medusajs/medusa-client-types';
import type { AdminPostProductCategoriesReq } from '@medusajs/medusa-client-types';
import type { AdminProductCategoriesCategoryDeleteRes } from '@medusajs/medusa-client-types';
import type { AdminProductCategoriesCategoryRes } from '@medusajs/medusa-client-types';
import type { AdminProductCategoriesListRes } from '@medusajs/medusa-client-types';
